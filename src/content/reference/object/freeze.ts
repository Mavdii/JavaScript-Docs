...
export const objectFreezeReference: ReferenceContent = {
  ...
  sections: [
    ...
    { type: 'code', language: 'javascript', filename: 'freeze-vs-seal.js', code: `// seal(): can modify existing, can’t add/delete\nconst sealed = Object.seal({ a: 1, b: 2 });\nsealed.a = 10;      // â Works\nsealed.c = 3;       // â Fails\ndelete sealed.a;    // â Fails\n\n// preventExtensions(): can modify and delete, can’t add\nconst ext = Object.preventExtensions({ a: 1, b: 2 });\next.a = 10;         // â Works\ndelete ext.b;       // â Works\next.c = 3;          // â Fails\n\n// Check methods\nObject.isFrozen(frozen);              // true\nObject.isSealed(sealed);              // true\nObject.isExtensible(ext);             // false` },
