  ...
  },
  {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          { label: 'Object.keys() / values()', href: '/reference/object/keys-values', description: 'Get property iterables' },
  ...
  },
  {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          { label: 'OAuth & JWT', href: '/integrations/oauth-jwt' },
          ...
          { label: 'Supabase / Firebase', href: '/integrations/baas' },
          { label: 'Push Notifications', href: '/integrations/push' },
        ],
      },
    ],
  },
  {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          { label: 'Debouncing & Throttling', href: '/recipes/debouncing-throttling' },
